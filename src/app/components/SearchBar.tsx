      ...
      <form onSubmit={handleFullSearch}>
        <div className="relative">
          <input
            ...
            // --- FIX: Added 'text-gray-900' to make the input text dark ---
            className="w-full pl-10 pr-4 py-2 text-sm text-gray-900 border border-gray-300 rounded-full focus:ring-2 focus:ring-brand focus:border-transparent transition-all"
