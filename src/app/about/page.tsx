...
export default function AboutPage() {
  return (
    <div className="relative min-h-screen w-full flex items-center justify-center bg-gradient-to-br from-gray-50 via-cyan-50 to-blue-100 p-4 overflow-hidden">
        ...
        <div className="relative container mx-auto max-w-4xl py-16 px-4 z-10">
            <div className="bg-surface rounded-xl shadow-2xl border p-8 md:p-12 space-y-6">
