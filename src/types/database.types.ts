  ...
  public: {
    ...
    Functions: {
      ...
      admin_adjust_credits: {
        Args: { p_user_id: string; p_amount_to_add: number; p_reason: string }
        Returns: undefined
      }
      agent_accept_task: {
      ...
      cancel_order_and_refund: {
        Args: { p_order_id: number; p_buyer_id: string }
        Returns: undefined
      }
      create_bulk_notifications_securely: {
        Args: { notifications_data: Json }
        Returns: undefined
      }
      ...
      process_verified_payment: {
        Args: { p_order_id: number; p_paystack_ref: string }
        Returns: undefined
      }
    ...
    Enums: {
      ...
      badge_type: "first_sale" | "top_seller" | "power_buyer" | "quick_shipper"
